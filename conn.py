...
engine = db.create_engine('mysql+pymysql://hack4:0713@192.168.52.36:3306/hack4')
...
# symptom table 정의
symptom = pd.DataFrame({'deptEng':[ "MKioskTy1","MKioskTy1", "MKioskTy2","MKioskTy3","MKioskTy4","MKioskTy5","MKioskTy5","MKioskTy5","MKioskTy6","MKioskTy9","MKioskTy10","MKioskTy10","MKioskTy11"],
                        'symptomName':["의식장애", "수족마비",'뇌경색','심근경색',"복부창상","손가락절단","개에게물림","신체절단","위경련","과호흡","소아머리손상","소아열성경련","화상"],
                        'firstAid':[
                            #1 의식장애
